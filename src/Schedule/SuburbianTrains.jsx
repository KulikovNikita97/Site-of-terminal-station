...
const SuburbianTrains = () => (
  <div>
    ...
    <div className={s.title}>
      <h1><b>Suburbian trains departure every 8-10 minutes!</b></h1>
      <h2>Comfort, safety, speed!</h2>

      <marquee direction="left" scrollamount="10" scrolldelay='0' bgcolor='yellow'>
        ATTENTION! Trains towards Rompale-city are canceled from January 24 until further notice.
      </marquee>

    </div>

    <Table style={{padding: '0 180px 0 180px'}}columns={columns} dataSource={data} />
